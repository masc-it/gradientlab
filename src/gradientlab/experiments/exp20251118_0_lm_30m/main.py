...
from gradientlab.experiments.exp20251118_0_lm_30m.modeling.factory import (
    GPTFactory,
)
from gradientlab.experiments.exp20251118_0_lm_30m.trainer import (
    Trainer,
)
...
def main():
    ...
    exp_cfg = ExpConfig()
    model, tokenizer, model_cfg = GPTFactory.build_30m(exp_cfg.resume_from)
